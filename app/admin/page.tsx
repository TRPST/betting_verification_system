              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">{data?.stats.totalVerified}</div>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">{data?.stats.flaggedForReview}</div>
                      <p className="text-xs text-muted-foreground">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">{data?.stats.fraudAlerts}</div>
                      <p className="text-xs text-muted-foreground">
                        {((data?.stats.fraudAlerts / data?.stats.totalProcessed) * 100).toFixed(1)}% of total
                      </p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <TabsContent value="overview" className="space-y-6">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <Card className="p-6">
                      <h2 className="text-xl font-semibold mb-4">Verification Trend</h2>
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                          <AreaChart data={data?.trendData}>
                            ...
                            <Tooltip
                              ...
                              formatter={(value: any) => [value, "Verifications"]}
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      ...
                      <div className="h-[250px]">
                        <ResponsiveContainer width="100%" height="100%">
                          <PieChart>
                            <Pie
                              data={[
                                { name: "Verified", value: data?.stats.totalVerified },
                                { name: "Pending", value: data?.stats.pendingVerifications },
                                { name: "Flagged", value: data?.stats.flaggedForReview },
                                { name: "Fraud", value: data?.stats.fraudAlerts },
                              ]}
                              cx="50%"
                              cy="50%"
                              labelLine={false}
                    ...
                    <Card className="p-6">
                      <h2 className="text-xl font-semibold mb-4">Hourly Distribution</h2>
                      <div className="h-[250px]">
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart data={data?.hourlyDistribution}>
                            ...
                            <Tooltip
                              ...
                              formatter={(value: any) => [`${value} verifications`, "Count"]}
                            />
                            <Bar 
                              dataKey="count" 
                    ...
                    <Card className="p-6">
                      <h2 className="text-xl font-semibold mb-4">Rejection Reasons</h2>
                      <div className="h-[250px]">
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart 
                      ...
                      {data?.recentActivity.slice(0, 10).map((activity: any) => (
                        ...
                        >
                          ...
                          <div className="flex items-center mt-2">
                            ...
                            {(activity.status.includes("⏳") || activity.status.includes("⚠️")) && (
                              <div className="ml-auto space-x-2">
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="text-xs h-8"
                                  onClick={() => handleAction("Approve", activity.id)}
                                >
                                ...
                                {activity.status.includes("⚠️") && (
                                  <Button
                                    ...
                                    size="sm"
                                    className="text-xs h-8"
                                    onClick={() => handleAction("Flag", activity.id)}
                                  >
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="text-xs h-8"
                                  onClick={() => handleAction("Reject", activity.id)}
                                >
                            ...
                            <div className="mt-4 pt-4 border-t text-sm">
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                  ...
                                  <p className="font-mono">{activity.idNumber}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                  ...
                                  <p className="flex items-center">
                                    {getDeviceIcon(activity.details.deviceType)}
                                    <span className="ml-1">
                                      {activity.details.deviceType} / {activity.details.browser}
                                    </span>
                                  </p>
                                </div>
                                <div>
                                  <p className="text-muted-foreground">IP Address:</p>
                                  <p className="font-mono">{activity.details.ipAddress}</p>
                                </div>
                                <div>
                                  <p className="text-muted-foreground">Verification Time:</p>
                                  <p>{activity.details.verificationTime} minutes</p>
                                </div>
                                {activity.details.rejectionReason && (
                                  <div>
                                    <p className="text-muted-foreground">Rejection Reason:</p>
                                    <p className="text-red-500">{activity.details.rejectionReason}</p>
                                  </div>
                                )}
                              </div>
                            </div>
                ...
                <TabsContent value="analytics" className="space-y-6">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <Card className="p-6">
                      <h2 className="text-xl font-semibold mb-4">Verification Time Trends</h2>
                      <div className="h-[300px]">
                        <ResponsiveContainer width="100%" height="100%">
                          <AreaChart data={data?.trendData}>
                            <defs>
                            ...
                            <Tooltip
                              ...
                              formatter={(value: any) => [value, "Total Verifications"]}
                              labelFormatter={(label) => formatDate(label)}
                            />
                            <Area
                              type="monotone"
                ...
                <TabsContent value="locations" className="space-y-6">
                  <Card className="p-6">
                    <h2 className="text-xl font-semibold mb-4">Verification by Location</h2>
                        ...
                        <TableBody>
                          {data?.locationStats.map((location: any) => (
                            <TableRow key={location.location}>
                              ...
                              <TableCell className="text-right">{location.total}</TableCell>
                              <TableCell className="text-right text-green-500">{location.verified}</TableCell>
                              <TableCell className="text-right text-yellow-500">{location.flagged}</TableCell>
                              <TableCell className="text-right text-red-500">{location.fraud}</TableCell>
                              <TableCell className="text-right font-medium">{location.verificationRate}%</TableCell>
                            </TableRow>
                          ))}
                        </TableBody>
                      </Table>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <Card className="p-6">
                      <h2 className="text-xl font-semibold mb-4">Top Locations by Volume</h2>
                      <div className="h-[300px]">
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart 
                    ...
                    <Card className="p-6">
                      <h2 className="text-xl font-semibold mb-4">Success Rate by Location</h2>
                      <div className="h-[300px]">
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart 
                            data={data?.locationStats.slice(0, 5).sort((a: any, b: any) => b.verificationRate - a.verificationRate)} 
                            layout="vertical"
                          >
                            <CartesianGrid strokeDasharray="3 3" className="stroke-muted" />
                            <XAxis 
